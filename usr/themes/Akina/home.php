	...
	<header id="we-header">
		<div class="we-branding">
			<div class="wesite-title">
				<a href="<?php $this->options ->siteUrl(); ?>" ><img src="<?php $this->options->themeUrl('images/akina.png'); ?>"></a>
			</div>
...
<div class="author-box">
	<div class="we-avatar">
		<div class="header-tou" >
			<a href="<?php $this->options ->siteUrl(); ?>"><img src="<?php $this->options->themeUrl('images/avatar.jpg'); ?>"></a>
		</div>	
	</div>
